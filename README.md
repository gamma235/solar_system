...
get the app created:
    ...
    $ heroku apps:create solar_system
    Creating solar_system... done, stack is cedar
    http://solar_system.herokuapp.com/ | git@heroku.com:solar_system.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://solar_system.herokuapp.com deployed to Heroku

    To git@heroku.com:solar_system.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://solar_system.herokuap.com
    ["Hello" :from Heroku]
